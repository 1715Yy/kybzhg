...
E[0]="Language:\n 1. English (default) \n 2. 简体中文"
C[0]="${E[0]}"
E[1]="Nezha Dashboard v0,v1 Combined for VPS (https://github.com/1715Yy/kybzhg).\n  \n  - Goodbye docker!\n  - Goodbye port mapping!\n  - Goodbye IPv4/IPv6 Compatibility!"
C[1]="哪吒面板 VPS 兼容v0、v1版 (https://github.com/1715Yy/kybzhg)\n  \n  - 告别 Docker！\n  - 告别端口映射！\n  - 告别 IPv4/IPv6 兼容性！"
E[2]="Curren architecture \$(uname -m) is not supported. Feedback: [https://github.com/1715Yy/kybzhg/issues]"
C[2]="当前架构 \$(uname -m) 暂不支持,问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
E[3]="Input errors up to 5 times.The script is aborted."
C[3]="输入错误达5次,脚本退出"
E[4]="The script must be run as root, you can enter sudo -i and then download and run again. Feedback:[https://github.com/1715Yy/kybzhg/issues]"
C[4]="必须以root方式运行脚本，可以输入 sudo -i 后重新下载运行，问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
E[5]="The script supports Debian, Ubuntu, CentOS, Alpine or Arch systems only. Feedback: [https://github.com/1715Yy/kybzhg/issues]"
C[5]="本脚本只支持 Debian、Ubuntu、CentOS、Alpine 或 Arch 系统,问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
E[6]="Curren operating system is \$SYS.\\\n The system lower than \$SYSTEM \${MAJOR[int]} is not supported. Feedback: [https://github.com/1715Yy/kybzhg/issues]"
C[6]="当前操作是 \$SYS\\\n 不支持 \$SYSTEM \${MAJOR[int]} 以下系统,问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
...
C[17]="请输入 Github PAT:"
E[18]="There are variables that are not set. Installation aborted. Feedback: [https://github.com/1715Yy/kybzhg/issues]"
C[18]="参数不齐，安装中止，问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
E[19]="Exit"
C[19]="退出"
...
C[21]="开启哪吒面板"
E[22]="Argo authentication message does not match the rules, neither Token nor Json, script exits. Feedback:[https://github.com/1715Yy/kybzhg/issues]"
C[22]="Argo 认证信息不符合规则，既不是 Token，也是不是 Json，脚本退出，问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
...
C[29]="卸载哪吒面板"
E[30]="Install 1715Yy's VPS with Argo v0,v1 Combined version (https://github.com/1715Yy/kybzhg)"
C[30]="安装 1715Yy 的 VPS argo 带远程备份的v0、v1兼容版 (https://github.com/1715Yy/kybzhg)"
E[31]="successful"
C[31]="成功"
E[32]="failed"
C[32]="失败"
E[33]="Could not find \$NEED_PORTS free ports, script exits. Feedback:[https://github.com/1715Yy/kybzhg/issues]"
C[33]="找不到 \$NEED_PORTS 个可用端口，脚本退出，问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
E[34]="Important!!! Please turn on gRPC at the Network of the relevant Cloudflare domain, otherwise the client data will not work! See the tutorial for details: [https://github.com/1715Yy/kybzhg]"
C[34]="重要!!! 请到 Cloudflare 相关域名的 Network 处打开 gRPC 功能，否则客户端数据不通!具体可参照教程: [https://github.com/1715Yy/kybzhg]"
...
E[36]="Downloading the \${FAILED[*]} failed. Installation aborted. Feedback: [https://github.com/1715Yy/kybzhg/issues]"
C[36]="下载 \${FAILED[*]} 失败，安装中止，问题反馈:[https://github.com/1715Yy/kybzhg/issues]"
...
check_cdn() {
  [ -n "$GH_PROXY" ] && wget --server-response --quiet --output-document=/dev/null --no-check-certificate --tries=2 --timeout=3 https://raw.githubusercontent.com/1715Yy/kybzhg/main/README.md >/dev/null 2>&1 && unset GH_PROXY
}
...
Documentation=https://github.com/1715Yy/kybzhg
...
EOF
    ...
    wget -qO- ${GH_PROXY}https://raw.githubusercontent.com/1715Yy/kybzhg/main/template/restore.sh | sed '1,/^########/d' >> ${WORK_DIR}/restore.sh
  fi
